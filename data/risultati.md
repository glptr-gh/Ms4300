...
|---|---|---|---|---|
| Taches + tutto | molte sì | tutto no | tutto no | 1 vs 2 — da discutere |
| Éclaircissement + tutto | alcune sì | tutto no | tutto no | 1 vs 2 — da discutere |
| Déchirures + Perte de matière | Intense | No | Intense | 2 vs 1 — probabilmente sì |
| Perte de souplesse + Humidité | Moyenne | No | Moyenne | 2 vs 1 — probabilmente sì |
| Perte de souplesse + Moisissures | Intense | No | Moyenne | 2 vs 1 — probabilmente sì |
| Plis + Moisissures | No | Moyenne | Moyenne | 2 vs 1 — probabilmente sì |
| Froissures + Moisissures | No | No | Moyenne | 1 vs 2 — probabilmente no |
| Lacunes + Poussière | No | No | Faible | 1 vs 2 — probabilmente no |
